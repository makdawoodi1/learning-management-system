...
export const generateCertificate = async (
  ...
  try {
    return new Promise((resolve, reject) => {
      ...
      const writeStream = fs.createWriteStream(path.join(__dirname, "certificate.pdf"))
      pdfDocument.pipe(writeStream);
      pdfDocument
        .rect(0, 0, pdfDocument.page.width, pdfDocument.page.height)
        .fill("#fff");
      ...
      pdfDocument.image(
        ...
        0,
        0,
        { width: pdfDocument.page.width, height: pdfDocument.page.height }
      );
      ...
      pdfDocument.image(
        ...
        pdfDocument.page.width / 2 - maxWidth / 2,
        60,
        {
      ...
      pdfDocument.moveTo(startLine2, signatureHeight);
