...
export const pages = {
    ...
    ProtectedRoutes: [
        ...
        { path: 'edit-course/:courseID', element: <EditCourse />, exact: false, allowedRoles: [USER_ROLE.ADMIN] },
        ...
        { path: 'quiz-attempts', element: <QuizAttempts />, exact: false, allowedRoles: [USER_ROLE.STUDENT] },
        { path: 'student-quiz-attempts', element: <StudentQuizAttempts />, exact: false, allowedRoles: [USER_ROLE.ADMIN] },
