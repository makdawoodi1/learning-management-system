...
export const pages = {
    ...
    ProtectedRoutes: [
        ...
        { path: 'submissions', element: <Submissions />, exact: false, allowedRoles: [USER_ROLE.ADMIN] },
        ...
        { path: 'settings', element: <AccountSettings />, exact: false, allowedRoles: [USER_ROLE.STUDENT, USER_ROLE.ADMIN] },
