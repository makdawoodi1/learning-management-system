...
export const pages = {
    ...
    ProtectedRoutes: [
        ...
        { path: 'assignments', element: <Assignments />, exact: false },
        ...
        { path: 'add-course/:courseID', element: <AddCourse />, exact: false },
        { path: 'edit-course/:courseID', element: <EditCourse />, exact: false },
        { path: 'enrolledcourses', element: <EnrolledCourses />, exact: false },
        { path: 'instructor-courses', element: <InstructorCourses />, exact: false },
        { path: 'billing', element: <Billing />, exact: false },
        { path: 'earnings', element: <Earnings />, exact: false },
        ...
        { path: 'submissions', element: <Submissions />, exact: false },
        { path: 'student-submissions', element: <StudentSubmissions />, exact: false },
        { path: 'submission-detail/:submissionID', element: <SubmissionDetail />, exact: false },
        { path: 'accountsettings', element: <AccountSettings />, exact: false },
        { path: 'notifications', element: <Notifications />, exact: false },
